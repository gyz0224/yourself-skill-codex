...
你想知道自己是怎么说话的吗？<br>
你想用"第三人称"观察自己的思维模式吗？<br>
你想把多年的聊天记录、日记、照片，变成一面能对话的镜子吗？<br>

**把真实的自己蒸馏成一个 AI Skill，和自己聊聊天。**

<br>

提供关于自己的原材料（微信聊天记录、日记笔记、朋友圈截图、照片）加上你对自己的描述<br>
生成一个**真正像你一样的 AI Skill**<br>
用你的口头禅思考，用你的方式回答问题，记得你去过的地方和走过的路
...
这个 Skill 不会定义你，它只是帮你把过去的自己暂停在一个可以被对话的页面上。你可以不同意它，可以纠正它，可以在未来的某个时刻用新的材料覆盖它。

因为最重要的不是这个 Skill 像不像你，而是你在创造它的过程中，又多认识了自己一点。
